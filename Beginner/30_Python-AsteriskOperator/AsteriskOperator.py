...
Lists/tuples/sets/strings can be unpacked into function arguments with one * if the 
length matches the parameters.
...
But be careful with the following merging solution. 
...
dict_a = {'one': 1, 'two': 2}
dict_b = {3: 3, 'four': 4}
# dict_c = dict(dict_a, **dict_b)  # won't work
# print(dict_c)
# this works:
dict_c = {**dict_a, **dict_b}
print(dict_c)
